...
driver = webdriver.Chrome("C:\laragon\www\python\chromedriver.exe")
...
time.sleep(1)
driver.find_element(
    'id', 'login-form__username').send_keys("197102151990071001")
driver.find_element(
    'id', 'login-form__password').send_keys("12344321")
driver.find_element(
